...
<head>
    ...
    <style>
        ...
        /* New CSS for the middle div */
        .middle-box {
            background-color: #6DA36CBA;
            width: 25%;
            height: 60%;
            position: absolute;
            top: 40%;
    ...
    width: 40%; /* Adjust the width of the label */
    text-align: left; /* Align label text to the left */
}

.middle-box input[type="text"],
.middle-box input[type="email"],
.middle-box select {
    margin-bottom: 10px;
    padding: 10px;
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-group">
            <label for="Teacher-id">Teachers ID:</label>
